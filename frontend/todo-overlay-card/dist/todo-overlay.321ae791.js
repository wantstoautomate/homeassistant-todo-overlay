    ...
    return b2`
      ...
      if (this.hoverItem === item.id) {
        this.hoverItem = void 0;
                    ...
                    @pointerup=${async () => {
      if (this.pointerDown && this.dragging && this.hoverItem === item.id) {
        await setParent(
          this.hass,
          this.config.entity,
          this.dragging,
...
__decorateClass([
  r5()
], TodoOverlayCard.prototype, "dragging", 2);
__decorateClass([
  r5()
], TodoOverlayCard.prototype, "hoverItem", 2);
