...
function M(t6, i8, s5 = t6, e7) {
  ...
  return h4?.constructor !== o7 && (h4?._$AO?.(false), void 0 === o7 ? h4 = void 0 : (h4 = new o7(t6), h4._$AT(t6, s5, e7)), void 0 !== e7 ? (s5._$Co ??= [])[e7] = h4 : s5._$Cl = h4), void 0 !== h4 && (i8 = M(t6, h4._$AS(t6, i8.values), h4, e7)), i8;
}
var R = class {
  constructor(t6, i8) {
...
var H = class {
  ...
  _$AI(t6, i8 = this, s5, e7) {
    ...
    if (void 0 === h4) t6 = M(this, t6, i8, 0), o7 = !a2(t6) || t6 !== this._$AH && t6 !== E, o7 && (this._$AH = t6);
      ...
      const e8 = t6;
      let n6, r6;
      for (t6 = h4[0], n6 = 0; n6 < h4.length - 1; n6++) r6 = M(this, e8[s5 + n6], i8, n6), r6 === E && (r6 = this._$AH[n6]), o7 ||= !a2(r6) || r6 !== this._$AH[n6], r6 === A ? t6 = A : t6 !== A && (t6 += (r6 ?? "") + h4[n6 + 1]), this._$AH[n6] = r6;
    }
    o7 && !e7 && this.j(t6);
  }
  j(t6) {
...
var r4 = (t6 = o5, e7, r6) => {
  ...
  if (void 0 === s5 && globalThis.litPropertyMetadata.set(i8, s5 = /* @__PURE__ */ new Map()), "setter" === n6 && ((t6 = Object.create(t6)).wrapped = true), s5.set(r6.name, t6), "accessor" === n6) {
    ...
    return { set(r7) {
      ...
      e7.set.call(this, r7), this.requestUpdate(o7, n7, t6, true, r7);
    }, init(e8) {
  ...
  if ("setter" === n6) {
    ...
    return function(r7) {
      const n7 = this[o7];
      e7.call(this, r7), this.requestUpdate(o7, n7, t6, true, r7);
    };
  }
...
function n4(t6) {
  return (e7, o7) => "object" == typeof o7 ? r4(t6, e7, o7) : ((t7, e8, o8) => {
    ...
    return e8.constructor.createProperty(o8, t7), r6 ? Object.getOwnPropertyDescriptor(e8, o8) : void 0;
  })(t6, e7, o7);
}
    ...
    return b2`
            <div class="date-picker-panel">
                ...
                <div class="date-picker-grid">
                    ...
                    ${Array.from({ length: totalDays }, (_2, i8) => {
      const day = i8 + 1;
  ...
  render() {
    ...
    return b2`
      ...
      (name, index) => b2`
                ...
                ${!this.entityIsLinked || this.draftValue.linked ? b2`
                            <div class="field">
                                <div class="complete-toggle">
                                    <ha-checkbox
                                        id="todo-item-linked"
...
__decorateClass([
  n4({ type: Boolean })
], TodoItemDialog.prototype, "entityIsLinked", 2);
__decorateClass([
  n4({ type: Boolean })
...
var TodoSaveLoadDialog = class extends i4 {
  ...
  renderCrumbs() {
    ...
    return crumbs.map((crumb, i8) => {
      const isCurrent = i8 === crumbs.length - 1;
      return b2`
                ${i8 > 0 ? b2`<span class="sep">›</span>` : ""}
                <button
                    type="button"
                    class=${isCurrent ? "current" : ""}
                    ?disabled=${isCurrent}
                    @click=${() => this.jumpToCrumb(i8)}
                >
                    ${crumb.title}
                </button>
            `;
...
var v2 = (o7, n6, e7) => {
  ...
  if (void 0 === e7) {
    ...
    e7 = new t5(i8, n7, o7, o7.options);
  } else {
    const t6 = e7._$AB.nextSibling, n7 = e7._$AM, c5 = n7 !== o7;
    if (c5) {
      let t7;
      e7._$AQ?.(o7), e7._$AM = o7, void 0 !== e7._$AP && (t7 = o7._$AU) !== n7._$AU && e7._$AP(t7);
    }
    if (t6 !== d3 || c5) {
      let o8 = e7._$AA;
      for (; o8 !== t6; ) {
        const t7 = i7(o8).nextSibling;
        i7(l3).insertBefore(o8, d3), o8 = t7;
      }
    }
  }
  return e7;
...
var c4 = e5(class extends i5 {
  ...
  dt(e7, s5, t6) {
    ...
    const l3 = [], o7 = [];
    let i8 = 0;
    for (const s6 of e7) l3[i8] = r6 ? r6(s6, i8) : i8, o7[i8] = t6(s6, i8), i8++;
